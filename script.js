console.log("Terminal Script Loaded - v2");
...
╚██████╔╝██████╔╝██║   ██║   ██║  ██║
 ╚═════╝ ╚═════╝ ╚═╝   ╚═╝   ╚═╝  ╚═╝`;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "         Embedded Software Development • Full Stack ML Developer \n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Full Stack ML and Embedded Software Developer",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Specializing in hardware, software, and cloud integration.",
      "#ffffff"
    )}
${this.wrapWithColor(
      "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
      "   Building intelligent systems and embedded solutions using",
      "#ffffff"
    )}
${this.wrapWithColor("   Python, React, Linux, and Google Cloud", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
      "   Deeply interested in Electronics and Computer Science intersection,",
      "#ffffff"
    )}
${this.wrapWithColor(
      "   focusing on MLOps and production-ready intelligent systems.",
      "#ffffff"
    )}

${this.wrapWithColor("⚡ Leadership", "#ff8c00")}
${this.wrapWithColor(
      "   Cloud Lead at GDG REVA, leading 3-time hackathon winning teams",
      "#ffffff"
    )}
${this.wrapWithColor("   and managing technical projects from ideation to delivery.", "#ffffff")}
...
<span style="color: #00ffff;">CropNow | Embedded Software Engineer</span>
${this.wrapWithColor(
      "Jul 2025 - Oct 2025 | Bengaluru, India (Hybrid)",
      "#ffffff"
    )}

• ${this.wrapWithColor("Embedded Systems", "#ffa07a")} - ${this.wrapWithColor(
      "Worked on Linux-based embedded systems and circuit design.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Cloud & ML", "#ffa07a")} - ${this.wrapWithColor(
      "Implemented Azure Cloud and ML integration for rover systems.",
      "#ffffff"
    )}
• ${this.wrapWithColor("RTOS", "#ffa07a")} - ${this.wrapWithColor(
      "Kernel development for real-time rover operations.",
      "#ffffff"
    )}

<span style="color: #00ffff;">GDG REVA | Cloud Lead</span>
${this.wrapWithColor(
      "Sept 2025 - Present | REVA University, Bengaluru",
      "#ffffff"
    )}

• ${this.wrapWithColor("Leadership", "#ffa07a")} - ${this.wrapWithColor(
      "Leading the Cloud Team at GDG REVA University.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Certifications", "#ffa07a")} - ${this.wrapWithColor(
      "Completed Google Cloud Study Jams with 19+1 skill badges.",
      "#ffffff"
    )}

<span style="color: #00ffff;">Open Source Contributor | Multiple Organizations</span>
${this.wrapWithColor(
      "Jun 2025 - Nov 2025",
      "#ffffff"
    )}

• ${this.wrapWithColor("Hacktoberfest", "#ffa07a")} - ${this.wrapWithColor(
      "4 PRs merged in MERN stack and automation projects.",
      "#ffffff"
    )}
• ${this.wrapWithColor("GSSoC & SSoC", "#ffa07a")} - ${this.wrapWithColor(
      "Python and JavaScript contributions across multiple repos.",
      "#ffffff"
    )}`;
...
${this.wrapWithColor("🏛️ Schooling:", "#ff8c00")}   ${this.wrapWithColor(
...
<span style="color: #00ffff;">• Embedded & Hardware:</span> ${this.wrapWithColor("Raspberry Pi, Jetson Nano, BeagleBone, Arduino, ESP, Linux, FreeRTOS, QNX, Zephyr, LTspice, Fusion 360", "#ffffff")}
<span style="color: #00ffff;">• AI / ML & Data:</span> ${this.wrapWithColor(" Roboflow, CVAT, YOLO, CNN, PyTorch, Scikit-Learn, Pandas, NumPy, OpenCV", "#ffffff")}
<span style="color: #00ffff;">• Cloud & DevOps:</span> ${this.wrapWithColor("Google Cloud, Azure, Docker, Kubernetes, Git, GitHub Actions, Vercel", "#ffffff")}
<span style="color: #00ffff;">• Frontend & UI:</span> ${this.wrapWithColor("React.js, Next.js, TypeScript, JavaScript, CSS, HTML5, Bootstrap, Material UI", "#ffffff")}
<span style="color: #00ffff;">• Backend & Automation:</span> ${this.wrapWithColor("Node.js, Express.js, MongoDB, AppScript, RESTful APIs, Python, Microservices", "#ffffff")}
<span style="color: #00ffff;">• Blockchain:</span> ${this.wrapWithColor("Ethereum, Polygon, Aptos, Flare, Solana, Stellar", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:udithsnair@example.com" style="color: #ffffff; text-decoration: none;">udithsnair@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://udithh.me" target="_blank" style="color: #ffffff; text-decoration: none;">udithh.me</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/Udith-Creates" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/Udith-Creates</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/udithsnair/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/udithsnair/</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "Smart Electrical SLD ID Extraction",
        description: "AI-based Model for Electrical Single Line Diagram (SLD) Intelligence Source Feeder Extraction.",
        image: "https://media.istockphoto.com/id/184612712/photo/hand-written-formulas-of-electrotechnics-and-electronics-on-white-background.jpg?s=2048x2048&w=is&k=20&c=uJ0edIwZocQEDzGC1-_-lX6-9RnvKKD0YiMY9kYJOks=",
        technologies: ["Python", "YOLO", "Excel"],
        demo: "https://udithh.me",
        repo: "https://github.com/Udith-creates/AI-based-Smart-Electrical-SLD-Intelligence-Source-Feeder-Extraction",
      },
      {
        title: "Traffic Incident Detection",
        description: "Intelligent real-time traffic incident detection using computer vision and YOLOv11.",
        image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=1000&auto=format&fit=crop",
        technologies: ["Python", "OpenCV", "YOLOv11"],
        demo: "https://udithh.me",
        repo: "https://github.com/Udith-creates/Intellignet-Traffic-Incident-Detection",
      },
      {
        title: "Airbag Deployment Simulation",
        description: "A real-time embedded safety system simulated using FreeRTOS for safety-critical deployment.",
        image: "https://images.unsplash.com/photo-1581092919534-1c8b0b1b8f4b?q=80&w=1000&auto=format&fit=crop",
        technologies: ["FreeRTOS", "QNX", "Zephyr", "Embedded C", "Safety Systems"],
        demo: "https://udithh.me",
        repo: "https://github.com/Udith-creates/Airbag-Deployment-Simulation",
      }
    ];
  }
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "udith@nair: ~/retro-portfolio";
...
╚██████╔╝██████╔╝██║   ██║   ██║  ██║
 ╚═════╝ ╚═════╝ ╚═╝   ╚═╝   ╚═╝  ╚═╝`;
    ...
    role.textContent = "Embedded Software Development • Full Stack ML Developer";
