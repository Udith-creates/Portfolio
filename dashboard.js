...
class CloudDashboard {
    ...
    createSkillsCharts() {
        ...
        this.createSkillChart('cloudSkillsChart', {
            labels: ['Python', 'YOLO / CV', 'PyTorch', 'Data Analysis'],
            data: [95, 92, 85, 88],
            colors: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0']
        });

        // Embedded & Hardware Skills Chart
        this.createSkillChart('programmingSkillsChart', {
            labels: ['Embedded C', 'FreeRTOS', 'Linux', 'Circuits'],
            data: [95, 92, 85, 90],
            colors: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0']
        });

        // Full Stack & Cloud Skills Chart
        this.createSkillChart('frameworksSkillsChart', {
            labels: ['Node.js', 'React', 'Google Cloud', 'Docker'],
            data: [90, 85, 92, 82],
            colors: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0']
        });
    }
    ...
    initializeAllFeatures() {
        ...
        setTimeout(() => {
            this.addTypingEffect('.profile-title', 'Full Stack ML and Embedded Software Developer', 150);
        }, 2000);
    }
}
